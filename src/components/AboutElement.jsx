    ...
    <div className='w-full flex flex-col gap-24'>
      ...
      <div className='w-full flex flex-col gap-4'>
        ...
        <motion.p
          ...
          viewport={{ Infinity }}
        >
          Hi, I'm Souvik Patra — a front-end developer passionate about creating clean, engaging user experiences. Currently in my third year at Bankura Unnayani Institute of Engineering, I've built various web projects using JavaScript, Tailwind CSS, and React.
        </motion.p>
