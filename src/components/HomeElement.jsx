    ...
    <div className="w-full">
      ...
      >
        ...
        <h1 className="text-5xl md:text-7xl lg:text-12xl font-bold text-white">
          SOUVIK <br className="max-lg:hidden" />
          <motion.span 
        ...
        >
          Passionate about crafting intuitive and engaging user experiences.<br className="max-md:hidden" />
          I transform ideas into visually stunning,<br className="max-md:hidden" />
          user-focused products that not only look<br className="max-md:hidden" /> 
          great but also deliver meaningful interactions.
        </motion.p>
      </motion.div>
      ...
      >
        ...
        {/* Projects */}
        <div className="flex flex-col items-center">
          <h1 className="text-7xl font-bold text-white">+4</h1>
