...
function Cards() {
  return (
    <div className='w-full pt-10 pb-10 pl-5 pr-5 h-auto lg:w-[350px] bg-white flex items-center justify-center flex-col rounded-md text-black text-center'>
        ...
        {/* Profile Name */}
        <h1 className='text-3xl font-semibold mt-5 lg:mt-7'>Souvik Patra</h1>
        ...
        <div className='mt-5 flex flex-wrap items-center justify-center gap-10'>
            ...
            {/* GitHub */}
            <a href="https://github.com/souvik-p01" target='_blank'>
                <img width={30} src={assets.github} alt="github" />
            </a>

            {/* Linkedin */}
            <a href="https://www.linkedin.com/in/souvik-patra-503a0a319/" target='_blank'>
                <img width={30} src={assets.linkedin} alt="linkedin" />
            </a>

            {/* Mail */}
            <a href="Gmail To:souvikpatra313@gmail.com" target='_blank' rel="noopener noreferrer">
